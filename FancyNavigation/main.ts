...
let navParentContainer = document.getElementById('nav-awards').parentElement.parentElement.parentElement;

let newNavContainer = document.createElement('div');
newNavContainer.className = 'account-links___EEEJs';

for (let i in customLinks) {
